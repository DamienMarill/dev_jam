...
function whereCountry(name){
  name = name.toUpperCase();
  return allCountriesId.find(function (country) {
      return country.country.toUpperCase() === name;
  })
}
function whereAlpha2(alpha2){
  alpha2 = alpha2.toUpperCase();
  return allCountriesId.find(function (country) {
      return country.alpha2 === alpha2;
  })
}
function whereAlpha3(alpha3){
  alpha3 = alpha3.toUpperCase();
  return allCountriesId.find(function (country) {
      return country.alpha3 === alpha3;
  })
}
function whereNumeric(numeric){
